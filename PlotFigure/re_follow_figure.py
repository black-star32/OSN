...
if __name__ == '__main__':
    file_path1 = r"D:\data\weibo_dataset\sample\negative_re_follow.txt"
    file_path2 = r"D:\data\weibo_dataset\sample\positive_re_follow.txt"
    ...
    plt.ylim(ymax=1)
    plt.ylim(ymin=0)
    plt.xlabel(u'follow_back_pro', fontsize=12, family='Times New Roman')
    plt.ylabel(u'CDF', fontsize=12, family='Times New Roman')
    plt.legend(loc='lower right')
    # plt.legend()
    plt.savefig(r"D:\pycharm\PyCharm 2018.3.2\projects\OSN\figures\re_follow_figure.pdf")
    plt.show()
